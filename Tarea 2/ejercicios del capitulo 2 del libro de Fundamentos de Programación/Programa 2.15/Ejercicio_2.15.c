...
/* Spa.
El programa, al recibir como datos el tipo de tratamiento, la edad y el numero de dias de internacion de un cliente de un spa, calcula el costo total del tratamiento.
