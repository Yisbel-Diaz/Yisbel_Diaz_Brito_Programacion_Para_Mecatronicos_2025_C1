...
/* Lluvias.
El programa permite calcular el promedio mensual de las lluvias caidas en tres regione importantes del pais. determina tambien cual es la region con mayor promedio de lluvia anual */
