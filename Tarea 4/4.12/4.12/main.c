...
{
    int NU1, NU2, RES;
    printf("\nIngresa los datos numeros enteros: ");
    scanf("%d %d", &NU1, &NU2);
    RES = mcd (NU1, NU2);
...
/* Esta funcion calcula el maximo comun divisor de los numeros N1 y N2. */
{
    ...
    while ((N1 % I) || (N2 % I))
        /* El ciclo se mantiene activo mientras (N1 % I) o (N2 % I) sean distintos de cero. cuando el resultaod de la evaluacion sea 0, el ciclo se detiene ya que se habra encontrado el maximo comun divisor. */
          I--;
        return I;
}
